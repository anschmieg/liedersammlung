def chordpro_to_latex(input):
    ...
    directives = {
        ...
        "start_of_verse": "begin{songVerse}",
        "end_of_verse": "begin{songVerse}",
        "start_of_bridge": "begin{songBridge}",
        "end_of_bridge": "end{songBridge}",
        "c": "songComment",
        "soc": "begin{songChorus}",
        "eoc": "end{songChorus}",
        "sov": "begin{songVerse}",
        "eov": "end{songVerse}",
        "sob": "begin{songBridge}",
        "eob": "end{songBridge}",
        "new_page": "newpage",
        "np": "newpage",
        "chorus": "begin{songChorus}\\end{songChorus}",
    }
